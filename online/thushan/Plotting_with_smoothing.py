...
chart_titles = ['MNIST [500] (Test Error)','MNIST [500] (Validation Error)',
                ...
                'CIFAR-10 [1000] (Test Error)','CIFAR-10 [1000] (Validation Error)',
                'CIFAR-10 [1000,1000,1000] (Test Error)','CIFAR-10 [1000,1000,1000] (Validation Error)',
                'MNIST-ROT-BACK [500] (Test Error)','MNIST-ROT-BACK [500] (Validation Error)',
                'MNIST-ROT-BACK [500,500,500] (Test Error)','MNIST-ROT-BACK [500,500,500] (Validation Error)']
...
for i in [0*6,2*6,4*6]:
    for j in [0,3]:
        ...
        plt.plot(x_axis,smooth_data[i+j],'r',label=legends[0])
        plt.plot(x_axis,smooth_data[i+j+1],'b',label=legends[1])
        plt.plot(x_axis,smooth_data[i+j+2],'g',label=legends[2])
